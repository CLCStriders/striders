...
`*` <em>Official published time used and ranked against others parkrunning in July</em>  
`**` <em>Official chip time used and ranked throughout the qualifying window</em>
