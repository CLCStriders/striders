# Welcome to the CLC Striders Website
...
This website is built using [Jekyll](https://jekyllrb.com/) - a static site generator built on [Ruby](https://www.ruby-lang.org/en/). It is hosted on [Github](https://github.com/).

Predominantly the codebase is Javascript plugins (image slider, [datatables](https://datatables.net), some vanilla javascript and HTML and CSS. 
