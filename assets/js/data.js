 ...
 $('#load_data').ready(function() {
     $.ajax({
         ...
         success: function(data) {
             ...
             $('#output_table_div').html(table_data).DataTable({
                 columns: [
                     { data: "Type" },
                     { data: "Gender" },
                     { data: "Distance" },
